...
if (isNaN(threads) || threads <= 0 || threads > 556) {
    console.error('Error threads can not high 556')
    process.exit(1);
}

if (isNaN(ratelimit) || ratelimit <= 0 || ratelimit > 900) {
    console.error(`Error ratelimit can not high 900`)
    process.exit(1);
}
